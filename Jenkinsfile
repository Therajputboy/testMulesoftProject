...
script{
  if(env.GIT_BRANCH == "Dev")
  {
    ...
    bat "mvn clean deploy -DmuleDeploy -DskipTests -Dmule.version=4.3.0 -Danypoint.username=${env.anypoint_username} -Danypoint.password=${env.anypoint_password} -Dtarget=TPH-MULE-DEV -Dtarget.type=server -Denv=Development -Dappname=cicd-test-app1"
  }
